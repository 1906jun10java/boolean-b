...
public class Budget_Ideal {
	...
	public Budget_Ideal(double ccInterest, double transportation, double housing, double grocery, double entertainment,
	...
	public Budget_Ideal(int budgetIId, double ccInterest, double transportation, double housing, double grocery,
	...
	public String toString() {
		return "Budget_Ideal [budgetIId=" + budgetIId + ", ccInterest=" + ccInterest + ", transportation="
